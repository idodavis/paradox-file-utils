...
// GenerateDiff generates a structured diff between two files
// Returns an array of DiffLine objects with type, content, and line numbers
// FIXME: But with First line always showing in diff, My guess is it's issue with BOM encoding special character and the merge tool outputting it.
func GenerateDiff(beforeFilePath string, afterFilePath string) ([]DiffLine, error) {
