<template>
  <div class="flex-1 grid grid-cols-2 gap-6 p-6 overflow-auto bg-dark-input">
    <!-- Configuration Panel -->
    <div
    ...
    <!-- Diff Panel Overlay -->
    <DiffViewer :visible="diffFilePath" :lines="diffLines" :loading="diffLines.length === 0 && diffFilePath"
      @close="closeDiff" />
  </div>
</template>
