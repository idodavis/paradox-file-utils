...
import { GetLatestPatchNotes } from "../../bindings/paradox-modding-tools/services/steamservice";
import type { LatestPatchNotes } from "../../bindings/paradox-modding-tools/services/models";
...
<template>
  <div class="relative z-10 mx-auto flex min-h-0 flex-1 flex-col gap-6 p-4 lg:max-w-7xl lg:flex-row lg:items-center">
    ...
    <div class="w-full lg:w-auto">
      <UCard
        class="w-full cursor-pointer shadow-xl bg-elevated/85 transition-colors hover:bg-elevated lg:max-w-[25rem]"
    ...
    <UModal
      v-model:open="patchNotesDialogOpen"
