...
import { BuildTree } from "../../bindings/paradox-modding-tools/services/fileservice";
import { GetDocContent, GetDocPathCache, Scan } from "../../bindings/paradox-modding-tools/services/moddocservice";
import { GetSettings } from "../../bindings/paradox-modding-tools/services/settingsservice";
import type { TreeNode } from "../../bindings/paradox-modding-tools/services/models";
import DocContentPane from "../components/DocContentPane.vue";
...
const activeTab = ref<"docs" | "wiki">("docs");
const tabItems = [
  { label: "Script docs", value: "docs" },
  { label: "Modding Wiki", value: "wiki" },
];
...
<template>
  <div class="relative flex min-h-0 flex-1 flex-col p-4 max-w-full min-w-0 overflow-auto">
    ...
    <div
      v-if="activeTab === 'docs'"
      class="flex min-h-0 flex-1 flex-col gap-4 rounded-lg border border-default bg-muted/60 p-2"
    >
      <UCard>
    ...
    <div v-else class="flex min-h-0 flex-1 flex-col rounded-lg border border-default bg-muted/60 p-2">
