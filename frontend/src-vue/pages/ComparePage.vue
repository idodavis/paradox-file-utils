...
import { BuildTree, ReadFileContent } from "../../bindings/paradox-modding-tools/services/fileservice";
import { DirectoryCompare, VanillaCompare } from "../../bindings/paradox-modding-tools/services/compareservice";
import type { PathMatch, TreeNode } from "../../bindings/paradox-modding-tools/services/models";
import DiffView from "../components/DiffView.vue";
import FileSelector from "../components/FileSelector.vue";
import SplitPane from "../components/SplitPane.vue";
import { useCurrentGame } from "../composables/appContext";
import { GetSettings } from "../../bindings/paradox-modding-tools/services/settingsservice";
...
const compareMode = ref<"vanilla" | "directory" | "file">("vanilla");
...
<template>
  <div class="flex min-h-0 flex-1 flex-col gap-4 overflow-auto p-4">
    ...
    <USelect v-model="compareMode" :items="compareModeOptions" value-key="value" />
    ...
    <UCard v-if="compareMode === 'vanilla'">
      <div class="space-y-4">
        ...
        <FileSelector
          v-model="modPath"
          label="Mod (B)"
          dialog-title="Select Mod (B) files/folders"
          mode="folder"
    ...
    <UCard v-else-if="compareMode === 'directory'">
      <div class="space-y-4">
        <FileSelector
          v-model="setAPath"
          label="Set A"
          dialog-title="Select Set A files/folders"
          mode="folder"
        ...
        <FileSelector
          v-model="setBPath"
          label="Set B"
          dialog-title="Select Set B files/folders"
          mode="folder"
          ...
          <div v-if="selectedRow" class="flex h-full min-h-0 flex-col overflow-hidden">
            ...
            <div class="min-h-0 flex-1">
              <DiffView
                ...
                :original-label="selectedRow.pathA"
                :modified-label="selectedRow.pathB"
