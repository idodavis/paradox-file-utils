...
import {
  ...
  RenameInventory,
  SaveInventory,
} from "../../bindings/paradox-modding-tools/services/inventoryservice";
import type { InventoryItemRow, InventorySummary } from "../../bindings/paradox-modding-tools/services/models";
...
<template>
  <div class="flex min-h-0 flex-1 flex-col gap-4 overflow-auto p-4">
    ...
    <UAlert
      ...
      description="Extraction returned one or more errors."
    >
      <template #body>
