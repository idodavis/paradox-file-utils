...
- **JSON app store:** `services.OpenStore()` / `store.go`. Types: `GameInstall` (`VersionDetected`, `IsBroken`), `Workspace` (`DefaultLocLang`), settings map. No SQLite, no DbService.
